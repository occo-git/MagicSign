...
public class UserVideoCount {
    ...
    public boolean sharedPotionDisabled() {
        // проверяем, что potion не доступна на основе количества отправленных ссылок и скриншотов
        return getSharedLinks() + getSharedScreenshots() < CurrentSettings.potionShareCount;
    }
    ...
    public float sharedPercent() {
        return (float)(getSharedLinks() + getSharedScreenshots()) / CurrentSettings.potionShareCount;
    }
    //endregion
