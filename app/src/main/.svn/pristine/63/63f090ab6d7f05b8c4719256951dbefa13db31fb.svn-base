...
public abstract class Utils {
    ...
    public static void Toast(int messageId) {
        MainActivityUtils.doToast(getRes(messageId));
    }
    public static void Toast(String message) {
        MainActivityUtils.doToast(message);
    }
    public static void ToastError(String str, Throwable t) {
        MainActivityUtils.doToast(str + " error: " + t.toString());
    }
    //endregion
    ...
    public static void CrashReport(String str, Throwable t) {
        FirebaseCrashlytics.getInstance().recordException(new Exception(str, t));
    ...
    public static long stopMusicWithDelay() {
        if (musicPlayer != null)
            return musicPlayer.stopWithDelay();
        return 0;
    }
    ...
    /*public static void playMusicFile(int fileId, boolean isForce) {
        if (musicPlayer != null)
            musicPlayer.playFile(fileId, isForce);
    }*/
    //endregion
    //region Play
    ...
    public static void playSoundWave() {
        switch (getRandom(2)) {
            case 0: playSound(R.raw.wave03); break;
            case 1: playSound(R.raw.wave04); break;
        }
    }
    public static void playSoundClick() { playSound(R.raw.ui_item_click14); }
    public static void playSoundTap() { playSound(R.raw.ui_item_click15); }

    public static void playSoundPlop() {
        switch (getRandom(2)) {
            case 0: playSound(R.raw.plop04); break;
            case 1: playSound(R.raw.plop05); break;
        }
    }
    public static void playSoundLightning() {
        switch (getRandom(3)) {
            ...
            case 2: playSound(R.raw.lightning04); break;
        }
    }
    //endregion
    //region Vibrate
