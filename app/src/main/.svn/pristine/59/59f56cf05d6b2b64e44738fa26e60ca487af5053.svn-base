...
public class GrpPauseMenuDialog extends GrpDialog {
    ...
    private static final float dxDrop =   .50f, dyDrop =     .55f;
    private static final float dyStart =  1 / 6f;
    private static final float dxBtn0 =    .2f;
    private static final float dxBtn1 =    .25f;
    private static final float dxBtn2 =   .75f;
    ...
    public GrpPauseMenuDialog() {
        ...
        setDlgMessageText(R.string.dlg_Pause_Title, .5f, .15f);
        ...
        //region options
        /*BtnBase btnOptions = new BtnBase(getByDx(dxBtn0), getByDy(3f * dyStart + .5f * dyBtn), fdBtn, R.string.bmp_btn_options);
        ...
        addDlgControlTouchable(btnOptions, dxBtn0, 3f * dyStart + .5f * dyBtn);*/
        //endregion

        float dy = 3f * dyStart + 1.5f * dyBtn;

        //region exit
        BtnBase btnExit = new BtnBase(getByDx(dxBtn1), getByDy(dy), fdBtn, R.string.bmp_btn_exit);
        ...
        addDlgControlTouchable(btnExit, dxBtn1, dy);
        //endregion

        //region play
        BtnBase btnPlay = new BtnBase(getByDx(dxBtn2), getByDy(dy), fdBtn, R.string.bmp_btn_play);
        btnPlay.name = "btn_menu_play";
        btnPlay.setLabelText(R.string.dlg_Play); //R.string.dlg_Menu_Continue);//, DrawingHAlign.RIGHT);
        btnPlay.setListener(new IClickListener() {
            @Override public void handleOnClick(ITouchable e) { onResult(DIALOG_RESULT_PLAY); }
        });
        addDlgControlTouchable(btnPlay, dxBtn2, dy);
        //endregion
