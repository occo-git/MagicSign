...
public class ActivityGroupBase extends DrawingGroup {
    ...
    private boolean isUseConnectionDialog = false;
    ...
    protected ActivityGroupBase(boolean isUseNoConnectionDialog) {
        ...
        isUseConnectionDialog = isUseNoConnectionDialog;
    ...
    private void showConnectionDialog() {
        if (CurrentSettings.isUseNoConnectionDialog && isUseConnectionDialog && !isCurrentDialog(dlgNoConnection))
