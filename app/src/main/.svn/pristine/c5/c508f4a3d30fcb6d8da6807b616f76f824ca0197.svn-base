...
public class GrpUserInfos extends ActivityGroupBase {
    ...
    protected GrpUserInfos(boolean isUseNoConnectionDialog, boolean isBackAndOptions) {
        ...
        btnLogIn.clickSoundId = R.raw.ui_item_click14;
        ...
        btnShare.clickSoundId = R.raw.ui_item_click14;
    ...
    protected void addHelpItems(int[] data) {
        ...
        btnHelp.clickSoundId = R.raw.ui_item_click14;
    ...
    private void loadUserPhoto(int hash) {
    ...
    protected void refreshControls() {
        if (dlgShare != null)
            dlgShare.applySettings(userVideoCount);
        if (dlgPotionVideos != null)
