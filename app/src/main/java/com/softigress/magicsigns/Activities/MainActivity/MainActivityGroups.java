...
class MainActivityGroups {
    ...
    private ActivityGroupBase currentGroup;
    ...
    public void load() {
        ...
        try {
            ...
            MainActivityUtils.setMainListener(new IMainListener() {
                @Override public void handleOnToast(String message) { onToast(message); };
    ...
    private void onToast(String message) { mainActivity.onToast(message); }
    ...
    private void onPause(GrpDialog dlg) {
        if (currentGroup != null)
            currentGroup.onPauseGroup(dlg);
    }
    private void onResume() {
        if (currentGroup != null)
            currentGroup.onResumeGroup();
    }
    //endregion
