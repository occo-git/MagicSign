...
public abstract class MainActivityUtils {
    ...
    public static void doToast(String message) {
        if (mainListener != null)
            mainListener.handleOnToast(message);
    }

    public static void doInitAd() {
        Utils.LogEvent(AnalyticsManager.MS_EVENT_ACTION, "act_init_ad");
        if (mainListener != null)
            mainListener.handleOnInitAd();
    }
