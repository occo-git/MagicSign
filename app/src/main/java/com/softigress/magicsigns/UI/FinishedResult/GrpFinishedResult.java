...
public class GrpFinishedResult extends DrawingGroup {
    ...
    private final static float xCrown =    .50f,    yCrown =    .134f,  fdCrown =       .233f;
    ...
    public GrpFinishedResult(IGrpFinishedResultListener l) {
        ...
        btnRepeat.setListener(new IClickListener() {
            ...
            public void handleOnClick(ITouchable e) {
                ...
                if (CurrentSettings.isAdvVideo && CurrentSettings.isShowAdvVideo)
                    ...
                    CurrentSettings.isShowAdvVideo = true;
                }
            }
        });
        ...
        btnShare.setLabelTextSized(R.string.dlg_Share_Screenshot, TextUtils.dialog_text_xxsmall, DrawingHAlign.RIGHT);
    ...
    public void setResult(FinishedResultInfo finishedResult) {
        ...
        if (isWin) {
            ...
            //long delay = Utils.stopMusicWithDelay();
            //Utils.playSound(R.raw.orden_short, delay);
            Utils.playMusic(3005); // orden_short
        } else {
            orden.hide();
