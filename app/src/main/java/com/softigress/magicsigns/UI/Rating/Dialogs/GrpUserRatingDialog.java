...
public class GrpUserRatingDialog extends GrpDialog {
    ...
    private static final float fwWaveBar =    .380f, fhWaveBar =      .020f;
    ...
    private void currentUserControlsShowHide(boolean isShowHide) {
        boolean isVideosHide = this.ratingRowInfo == null || this.ratingRowInfo.userScoreInfo == null || this.ratingRowInfo.userScoreInfo.allPotions();
