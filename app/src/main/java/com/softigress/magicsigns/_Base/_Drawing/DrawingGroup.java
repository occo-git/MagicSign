...
public class DrawingGroup implements IDrawing, ITouchable {
    ...
    public synchronized void calc() {
        ...
        try {
            ...
            String str = "DrawingGroup.calc [" + toString() + "]";
    ...
    public synchronized void drawFrame(Canvas c) {
        ...
        try {
            ...
            String str = "DrawingGroup.drawFrame [" + toString() + "]";
            Utils.CrashReport(str, t);
            throw t;
        }
    }
    ...
    protected void drawItems(Canvas c) {
        ...
        try {
            ...
            //if (step < 4 && i != null)
            //    str += " [" + i.toString() + "]";
            Utils.CrashReport("DrawingGroup.drawItems", t);
            throw t;
        }
    }
