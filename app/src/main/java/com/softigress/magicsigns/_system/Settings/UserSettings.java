...
public class UserSettings extends SettingsBase {
    ...
    private SettingBase<Integer> age;
    ...
    public UserSettings(SharedPreferences sp, SharedPreferences.Editor editor) {
        ...
        this.soundVol = new SettingBase<>("user_sound_vol", .75f);
        this.music = new SettingBase<>("user_music", 1);
        this.musicVol = new SettingBase<>("user_music_vol", .25f);
        this.vibr = new SettingBase<>("user_vibr", 0);
        ...
        this.story = new SettingBase<>("user_story", 1); // отображать заставку
        this.age = new SettingBase<>("user_age", 0);
    }
    ...
    public boolean isStory() { return story != null && story.v == 1; }
    public void storyOnOff(boolean onoff) { story.v = onoff ? 1 : 0; }

    public Integer getAge() { return age != null ?  age.v : 0; }
    public void setAge(int val) { age.v = val; }
    public boolean isAdult() { return age != null && age.v >= CurrentSettings.adultAge; }
