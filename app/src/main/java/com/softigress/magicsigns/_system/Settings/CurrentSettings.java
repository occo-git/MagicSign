...
public abstract class CurrentSettings {
    ...
    public static final boolean isAdvVideo = true; // признак Показывать рекламное видео
    public static final boolean isCheckConnection = true;
    public static final boolean isUseNoConnectionDialog = true;
    ...
    public static final int signPodsCount = 14; // число pods в sign
    ...
    public static final int signBreakDuration = 1000; // время анимации уничтожения DrawingSignCell
    ...
    public static final int potionShareCount = 5; // необходимое количество отправленных ссылок или скриншотов, чтобы получить potion
    ...
    public static final int windowShowDuration = 500;//120; // время отображения окон
    public static final int windowHideDuration = 60;//60; // время закрытия окон
